...
public class ImageShape implements TurtleShape {
	...
	public Builder(File imageFile) {
		...
		throw new RuntimeException("Parameter imageFile does not contain valid name of an image file ("
			+ e.getMessage() + ")");
	    }
	}
	...
	public Builder(String imageLocation) {
	    ...
	    if (imageURL == null)
		throw new RuntimeException("Parameter imageLocation (" + imageLocation
			+ ") does not refer to an image file");
	}
     ...
     * 
     * @param imageFile file with the image for the shape
     */
